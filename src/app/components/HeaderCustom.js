        ...
        <Menu mode="horizontal" style={{ lineHeight: '64px', float: 'right' }} onClick={this.menuClick}>
          ...
          <SubMenu
            title={
              <span className="avatar">
                <img src="https://gaomingwei.xyz/wp-content/uploads/2019/07/WechatIMG3.jpeg" alt="头像" />
          ...
          >
            <MenuItemGroup title="用户中心">
              ...
              <Menu.Item key="setting:1">你好 - 执念</Menu.Item>
              <Menu.Item key="setting:2">
                <span onClick={this.onUserInfo}>个人信息</span>
              </Menu.Item>
            ...
            <MenuItemGroup title="设置中心">
              <Menu.Item key="setting:3">
                <span onClick={this.onceSetting}>个人设置</span>
              </Menu.Item>
              <Menu.Item key="setting:4">
                <span onClick={this.sysSeting}>系统设置</span>
              </Menu.Item>
            </MenuItemGroup>
          </SubMenu>
        </Menu>
